            ...
            <tbody>
              {machines.map((machine, index) => (
                <tr key={machine._id || index}>
                  ...
                  <td data-label="Brand">{machine.title}</td>
                  <td data-label="Category">{machine.category}</td>
                  <td data-label="Purpose (Type)">
                    <span className={`badge badge-${(machine.type || machine.purpose || '').toLowerCase()}`}>
                      {machine.type || machine.purpose}
                    </span>
                  </td>
                  <td data-label="Year">{machine.year}</td>
                  <td data-label="Hours">{machine.hours.toLocaleString()}</td>
