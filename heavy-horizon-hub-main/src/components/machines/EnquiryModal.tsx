...
import { Machine, EnquiryData } from '@/types/machine';
...
interface EnquiryModalProps {
  ...
  enquiryType: 'Rental' | 'Sales' | 'Contact';
}

export function EnquiryModal({ isOpen, onClose, machine, enquiryType }: EnquiryModalProps) {
