  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        setStats({
          machines: machines.length || 10,
          parts: parts.length || 6,
          blogs: blogs.length || 5,
          enquiries: enquiries.length || 12
        });

        setRecentEnquiries(enquiries.slice(0, 5) || [
          { id: 1, type: 'Rental', machine: 'JCB 3DX', mobile: '+91 98765 43210', created_at: '2024-01-15' },
          { id: 2, type: 'Sales', machine: 'CAT 320D', mobile: '+91 87654 32109', created_at: '2024-01-14' },
          { id: 3, type: 'Parts', part: 'Hydraulic Pump', mobile: '+91 76543 21098', created_at: '2024-01-13' }
        ]);
      } catch (error) {
